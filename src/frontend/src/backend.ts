...
export class Backend implements backendInterface {
    ...
    async createShareLink(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createShareLink(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAlbum(arg0: string): Promise<Album> {
        if (this.processError) {
            try {
    ...
    async getPhotos(arg0: Array<string>): Promise<Array<Photo>> {
        if (this.processError) {
            try {
    ...
    async getSharedAlbum(arg0: string): Promise<Album> {
        if (this.processError) {
            try {
                const result = await this.actor.getSharedAlbum(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSharedPhotos(arg0: string, arg1: Array<string>): Promise<Array<Photo>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSharedPhotos(arg0, arg1);
                return from_candid_vec_n17(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async reorderPhotos(arg0: string, arg1: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.reorderPhotos(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateAlbumName(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateAlbumName(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePhotoCaption(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePhotoCaption(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadPhotos(arg0: string | null, arg1: string, arg2: string, arg3: bigint, arg4: string | null, arg5: ExternalBlob): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadPhotos(to_candid_opt_n18(this._uploadFile, this._downloadFile, arg0), arg1, arg2, arg3, to_candid_opt_n18(this._uploadFile, this._downloadFile, arg4), await to_candid_ExternalBlob_n19(this._uploadFile, this._downloadFile, arg5));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        caption: record_opt_to_undefined(from_candid_opt_n16(_uploadFile, _downloadFile, value.caption))
    };
}
